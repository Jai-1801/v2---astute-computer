        ...
        <div className="relative z-10 w-full px-6 sm:px-8 md:px-12 lg:px-20 xl:px-32 pt-24 sm:pt-24 md:pt-28 lg:pt-28">
          <div className="max-w-3xl">
            ...
            <div className="mb-5 sm:mb-6 inline-flex items-center">
              <span className="px-3 py-1.5 bg-white text-[#305CDE] text-xs sm:text-sm md:text-base font-semibold rounded-l-md">
                New
              </span>
              <span className="px-3 sm:px-4 py-1.5 bg-gray-800/80 backdrop-blur-sm text-white text-xs sm:text-sm md:text-base rounded-r-md">
                Now offering AI-powered solutions
              </span>
            </div>

            {/* Headline - 6S Consulting Typography Style */}
            <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-[3.5rem] xl:text-[4rem] font-bold tracking-tight leading-[1.15] md:leading-[1.2] lg:leading-[1.25] mb-5 sm:mb-6 md:mb-8">
            ...
            <p className="text-sm sm:text-base md:text-lg lg:text-xl xl:text-[1.35rem] text-white font-medium max-w-2xl mb-6 sm:mb-8 md:mb-10 leading-[1.6]">
            ...
            <div className="flex flex-col sm:flex-row items-start gap-4 mb-6 sm:mb-8 md:mb-10">
              <button
                ...
                className="group inline-flex items-center gap-2 pl-5 sm:pl-6 pr-2 py-2 bg-gradient-to-r from-[#305CDE] to-[#60A5FA] hover:from-[#2548B5] hover:to-[#3B82F6] text-white text-sm sm:text-base font-medium rounded-full transition-all"
              >
